"""Broken: treats any readmission ('<30' or '>30') as the positive class."""
...
X, y = features(df), (df["readmitted"] != "NO").astype(int)
model = make_pipeline(
    make_column_transformer(
        (OneHotEncoder(handle_unknown="ignore", min_frequency=50, sparse_output=False), CATEGORICAL),
